...
/* ==========================================================================
   1. SOLUTION DATABASE SCHEMAS
   ========================================================================== */
const solutionsManifest = {
    '1.1': {
        label: "Question 1.1",
        marks: "(2 Marks)",
        equation: "\\frac{2x^2 - 8x}{2x}",
    ...
    '1.3': {
        label: "Question 1.3",
        marks: "(6 Marks)",
        equation: "y = x - 3 \\quad \\text{and} \\quad x^2 + y^2 = 9",
    ...
    '1.6': {
        label: "Question 1.6",
        marks: "(4 Marks)",
        equation: "\\frac{3^{x+1} \\cdot 9^{x-2}}{27^{x-1}}",
        finalAnswer: "1",
